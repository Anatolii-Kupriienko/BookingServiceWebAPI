...
namespace API.Migrations
{
    ...
    [Migration("20240511175901_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.OwnerType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.RealEstateType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.RealEstate", b =>
                {
                    b.HasOne("API.Models.UserModel", "OccupiedBy")
                        .WithMany()
                        .HasForeignKey("OccupiedById");

                    b.HasOne("API.Models.UserModel", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Models.RealEstateType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.UserModel", b =>
                {
                    b.HasOne("API.Models.OwnerType", "OwnerType")
                        .WithMany()
