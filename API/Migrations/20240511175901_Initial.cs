        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeSquareMeters = table.Column<double>(type: "float", nullable: false),
                    ...
                    OccupiedById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RealEstate_AspNetUsers_OccupiedById",
                        column: x => x.OccupiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RealEstate_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_OwnerTypeId",
                table: "AspNetUsers",
                column: "OwnerTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RealEstate_OccupiedById",
                table: "RealEstate",
                column: "OccupiedById");
